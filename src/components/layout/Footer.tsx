      ...
      <div className="container mx-auto flex flex-col justify-between gap-6 px-4 text-sm text-muted-foreground md:flex-row md:items-start">
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-foreground">TTMerchant</span>
          </div>
          <p className="max-w-xs text-xs leading-5">
            Get your Trinidad &amp; Tobago business online. Powered by Sovereign Digital Group Limited.
          </p>
          <p className="text-xs">
        ...
        <div className="flex flex-wrap gap-x-8 gap-y-4">
          <div className="space-y-2">
            <h4 className="text-xs font-bold uppercase tracking-wider text-foreground">Merchant</h4>

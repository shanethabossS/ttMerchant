...
export const SOV_ECOSYSTEM: SovSite[] = [
  ...
  { name: 'SOV Predict', slug: 'sovpredict', url: 'https://sovpredict.vercel.app', description: 'Prediction markets and rewards', category: 'finance', live: true },
  ...
  { name: 'SOV Invoice', slug: 'sovinvoice', url: 'https://sov-invoice-saas.vercel.app', description: 'Invoicing and billing SaaS', category: 'finance', live: true },
